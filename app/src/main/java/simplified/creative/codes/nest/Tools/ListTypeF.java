...
public class ListTypeF extends ArrayAdapter {
    private Activity context;
    private List<String> strings;

    public ListTypeF(Activity context, List<String> strings, AdapterCallback adapterCallback) {
        super(context, R.layout.list_type_e, strings);
        this.context = context;
        this.strings = strings;
        this.listTypeFCallback = adapterCallback;
    }

    AdapterCallback listTypeFCallback;
    public interface AdapterCallback{
        void folder(String folderApp);
    }
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    ...
                    if((System.currentTimeMillis() - time) < 200){
                        listTypeFCallback.folder(strings.get(position));
                    }
                }
